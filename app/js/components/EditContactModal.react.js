		...
		return(
			<div id="edit_contact_modal" className="modal">
				...
				<div className="modal-footer">
					<a onClick={this._saveContact} className="modal-action modal-close waves-effect waves-green btn-flat">Update</a>
